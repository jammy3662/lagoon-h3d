...
Input npPressed; // buttons just pressed
Input npHeld; // buttons held or just pressed

struct {float x,y;} npJoystick; // analog movement
struct {float x,y;} npPointer; // analog aim / cursor control